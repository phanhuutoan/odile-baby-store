        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              Discover our most loved items, carefully selected for your little one.
            </p>
          </div>
        </div>
            ...
            <Card key={product.id} className="overflow-hidden transition-all hover:shadow-lg">
              <CardHeader className="p-0">
                <div className="relative">
                  ...
                  />
                  {product.badge && (
                    <Badge className="absolute right-2 top-2 bg-baby-pink text-white">{product.badge}</Badge>
                  )}
                </div>
              </CardHeader>
              ...
              <CardFooter className="p-4 pt-0">
                <Button className="w-full bg-baby-pink hover:bg-baby-pink/90 text-white">Add to Cart</Button>
              </CardFooter>
            </Card>
          ))}
        </div>
