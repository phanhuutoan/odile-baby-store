...
export default function Hero() {
  return (
    <section className="flex md:align-start relative bg-baby-pink/10 h-[calc(100vh-64px)]">
      <div className="container px-4 md:px-0 md:pr-0 md:mr-0">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
          ...
          >
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400 mx-auto md:mx-0">
          ...
          <div className="hidden md:block relative md:col-span-1 sm:col-span-2 flex items-center justify-center">
            <div className="relative">
              <img
                src="./hero-img.jpg"
                alt="Hero image"
                className="shadow-xl object-cover [clip-path:polygon(20%_0%,_100%_0,_100%_100%,_0%_100%)] h-[calc(100vh-40px)]"
              />
            </div>
          </div>
        </div>
